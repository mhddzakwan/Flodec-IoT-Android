...
CREATE TABLE `tb_prediksi` (
  ...
  `prediksi_berikutnya` varchar(20) NOT NULL,
...
INSERT INTO `tb_prediksi` (`id`, `latitude`, `longitude`, `rata2_curah`, `prediksi_menit`, `prediksi_berikutnya`, `debit`) VALUES
(1, 3.60527, 98.6261, 19.3333, 12, 'banjir rendah', 0);
